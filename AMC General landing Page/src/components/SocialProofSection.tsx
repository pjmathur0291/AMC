...
export default function SocialProofSection() {
  return (
    <section id="social-proof" className="py-20 md:py-24 bg-[#F8FAFC] text-[#161D4A] relative overflow-hidden border-t border-slate-100">
      {/* Decorative ambient gradients */}
      <div className="absolute top-10 left-10 w-64 h-64 bg-[#ADDDF1]/20 rounded-full pointer-events-none blur-3xl"></div>
      <div className="absolute bottom-10 right-10 w-72 h-72 bg-[#FED304]/10 rounded-full pointer-events-none blur-3xl"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Heading */}
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          <span className="text-xs font-extrabold uppercase tracking-widest text-[#161D4A] bg-[#161D4A]/5 border border-[#161D4A]/10 px-4 py-1.5 rounded-full inline-block">
            Student Testimonies
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight font-display text-[#161D4A]">
            What Our Students Say
          </h2>
          <p className="text-sm sm:text-base text-slate-600 leading-relaxed font-sans max-w-md mx-auto">
