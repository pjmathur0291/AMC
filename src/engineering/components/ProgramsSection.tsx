...
import {
  BTECH_COURSES,
  BTECH_WHAT_YOU_LEARN,
  BTECH_CAREER_PATHS,
  MTECH_COURSES,
  MTECH_WHAT_YOU_LEARN,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-[#161D4A]/70 leading-relaxed">
            AMC Engineering College provides modern research facilities and industry-connected curricula designed to
            accelerate technical capabilities.
          </p>
        </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-4 text-left">
              <div className="flex items-center justify-between border-b border-[#ADDDF1]/30 pb-3 mb-6">
                <h3 className="text-lg sm:text-xl font-bold font-display text-[#161D4A]">Available Streams & Focus Areas</h3>
                <span className="text-xs font-mono font-bold uppercase text-[#161D4A]/50 bg-[#ADDDF1]/20 px-2.5 py-1 rounded">
                  {degreeType === 'BTech' ? `${BTECH_COURSES.length} Specialties` : `${MTECH_COURSES.length} Specialties`}
                </span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <h4 className="text-sm sm:text-base font-extrabold text-[#161D4A] leading-snug">{course}</h4>
                      </div>
                      <ChevronRight
                        className={`w-4 h-4 text-[#161D4A]/40 transition-transform ${
                          isSelected ? 'translate-x-1 text-[#FED304]' : ''
                        }`}
                      />
                    </div>
                  );
            ...
            <div className="bg-[#FFFFFF] border border-[#ADDDF1]/30 rounded-2xl p-6 sm:p-8 space-y-6 w-full text-left flex-1 flex flex-col justify-between shadow-sm">
              <div className="space-y-6">
                <div className="space-y-1">
                  ...
                  <h3 className="text-xl font-bold font-display text-[#161D4A]">What You Learn</h3>
                </div>
                ...
                <div className="space-y-4">
                  {(
                    ...
                    <div key={index} className="flex items-start space-x-3.5 group" id={`curriculum-point-${index}`}>
              ...
              <div className="border-t border-[#ADDDF1]/30 pt-6 mt-6 space-y-4">
                <p className="text-xs text-[#161D4A]/60 leading-normal font-sans">
                  Need personalized advice? Receive counseling tailored for{' '}
                  <strong className="text-[#161D4A] font-semibold">{degreeType} Courses</strong>.
                </p>
                <button
                  onClick={() => {
