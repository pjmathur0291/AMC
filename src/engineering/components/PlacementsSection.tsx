...
import { Globe, Award, TrendingUp, DollarSign, ArrowRight, ShieldCheck, Building2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8 mb-20">
          {[
            ...
            return (
              <div
                key={i}
                className={`p-6 sm:p-8 rounded-2xl transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between bg-[#161D4A] text-[#FFFFFF] shadow-xl border border-white/5 ${
              ...
              >
                ...
                <div className="text-xs sm:text-sm font-bold uppercase tracking-wider text-[#ADDDF1]">{stat.label}</div>
              </div>
            );
          })}
        </div>
        ...
        <div className="space-y-10" id="career-paths">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2 text-left">
              <h3 className="text-xl sm:text-2xl font-bold font-display text-[#161D4A]">Career Paths</h3>
            ...
            <div className="flex space-x-3">
              {(['B.Tech', 'M.Tech'] as const).map((degree) => (
                <button
                  ...
                  className={`px-8 py-3 rounded-xl text-sm font-black tracking-widest uppercase transition-all duration-200 cursor-pointer ${
                    activeDegree === degree
            ...
            <div className="flex flex-wrap gap-2 overflow-x-auto pb-2 scrollbar-none pt-2">
              {courses.map((course) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-xs font-bold tracking-wider uppercase transition-all duration-250 cursor-pointer whitespace-nowrap ${
                    activeCourse === course
            ...
            <div className="space-y-3 pt-1">
              {ACCREDITATIONS.map((accred, idx) => (
                ...
                >
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-[#161D4A]/90">{accred}</span>
                </div>
              ))}
            </div>
          </div>
