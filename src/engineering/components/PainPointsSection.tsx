  ...
  const concerns = [
    {
      ...
      solution:
        'We provide industry-aligned curricula, certified lab infrastructures, and immediate exposure to emerging specialties (such as AI, Robotics, Data Science). Students execute real-world engineering prototypes rather than just memorizing textbook pages.',
      icon: Compass,
    ...
    },
    {
      ...
      solution:
        'Our dedicated training and placement cell partners directly with global brands like Infosys, Flipkart, Unisys, etc. AMC ensures a stellar 95% placement rate, with highest packages scaling to ₹33 LPA.',
      icon: Award,
      metric: '95% Placed',
    },
    {
      ...
      solution:
        'We host personal guidance sessions to trace your exact interests and map them to our diverse BTech program branches, helping you confidently choose your long-term scientific path.',
      icon: Rocket,
                  ...
                  >
                    <div className="flex justify-between items-center sm:items-start space-x-4">
                      <div className="flex items-start space-x-4">
                        <div
                          className={`p-2.5 rounded-lg border flex-shrink-0 transition-colors ${
                            isSelected
                        ...
                        <div className="space-y-1">
                          <h4
                            className={`text-base font-bold transition-colors ${
                              isSelected ? 'text-[#FED304]' : 'text-[#FFFFFF]'
                            }`}
                          >
                            {item.problem}
                          </h4>
                      ...
                      <ChevronRight
                        className={`w-5 h-5 text-[#ADDDF1]/70 flex-shrink-0 transform transition-transform duration-250 ${
            ...
            <div className="p-8 bg-gradient-to-br from-[#161D4A] to-[#161D4A]/90 border border-[#ADDDF1]/15 rounded-2xl shadow-xl space-y-6 text-left relative overflow-hidden group">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-[#FFFFFF]/85 leading-relaxed">
                  We don't just supply lessons; we construct launching pads. By pairing intensive laboratory work with
                  placement mentoring from the outset, we dissolve the uncertainty of college hunting.
                </p>
              </div>
