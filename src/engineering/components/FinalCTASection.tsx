...
import { Mail, Phone, User, BookOpen, Send, CheckCircle2, Clock, Check, ChevronRight } from 'lucide-react';
                  ...
                  {isSlotBooked ? (
                    <div className="p-6 bg-[#FFFFFF]/5 rounded-xl border border-dashed border-[#FED304]/30 text-center space-y-4 py-8">
                      ...
                      <div>
                        ...
                        <div className="inline-block mt-4 px-4 py-2 bg-[#FFFFFF]/10 border border-[#FFFFFF]/10 rounded-lg text-xs tracking-wide">
                          Slot:{' '}
                          <strong className="text-[#FED304] font-mono uppercase">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1">
                        <span className="text-[10px] font-mono uppercase text-[#ADDDF1] font-bold">
                          Step 2: Choose Date & Time Block
                        </span>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {['10:00 AM - 11:00 AM', '11:30 AM - 12:30 PM', '02:00 PM - 03:00 PM', '04:30 PM - 05:30 PM'].map(
                          (slot) => (
                            <button
                              key={slot}
                              type="button"
