import { Users, Workflow, Calendar, Landmark } from 'lucide-react';
  ...
  const experiences = [
    {
      ...
      description:
        'Students congregate in specialized bodies (like Coding Clubs, Robotics Societies, Maker Labs, and Aerodesign Forums) to solve engineering problems collaboratively.',
      icon: Users,
    ...
    },
    {
      ...
      description:
        'A continuous loop of group prototypes, collaborative sandbox modules, and cross-disciplinary research builds that cultivate industrial soft skills.',
      icon: Workflow,
    ...
    },
    {
      ...
      description:
        'Host to annual national hackathons, collegiate tech expos, computing forums, and sporting tournaments to celebrate student potential.',
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        'Framed by massive reading libraries, recreational centers, outdoor sports arenas, and quiet botanical zones favoring contemplative focus.',
      icon: Landmark,
                ...
                <div className="p-6 sm:p-8 flex-1 flex flex-col justify-between">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2.5">
                      ...
                      <h3 className="text-base sm:text-lg font-black text-[#161D4A] leading-tight mt-0.5">{exp.title}</h3>
                    </div>

                    <p className="text-xs sm:text-sm text-[#161D4A]/75 leading-relaxed font-sans">{exp.description}</p>
                  </div>
                </div>
              </div>
            );
