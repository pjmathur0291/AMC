            ...
            >
              ...
              <div className="border-t border-slate-100 mt-6 pt-6 flex justify-between items-end">
                <div className="space-y-1 min-w-0 flex-1">
                  <h4 className="text-sm font-extrabold text-[#161D4A] tracking-tight truncate">{quoteItem.author}</h4>
                ...
                <div className="pl-4 shrink-0 text-right">
                  <p className="text-[10px] text-slate-400 font-mono font-bold">{quoteItem.year}</p>
                </div>
              </div>
            </div>
          ))}
