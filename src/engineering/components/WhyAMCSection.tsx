import { Award, Compass, GraduationCap, Cpu } from 'lucide-react';
  ...
  const points = [
    {
      ...
      details:
        'A testament to our relentless pursuit of scholastic rigor representing premium pedagogy frameworks in India.',
      icon: Award,
    },
    {
      ...
      details:
        'Curriculums are continuously parsed alongside technical enterprises to ensure immediate employability upon graduation.',
      icon: Compass,
    },
    {
      ...
      details:
        'Equipped with advanced labs and micro-testing rigs where digital code blocks convert into physical mechanism variables.',
      icon: Cpu,
    },
    {
      ...
      details:
        'Establishing strong multi-lateral partnerships with prominent conglomerates to anchor reliable career start pathways.',
      icon: GraduationCap,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-sm sm:text-base text-[#161D4A]/70 leading-relaxed font-sans">
            AMC Engineering College merges intensive physical lab experiences with a robust syllabus, crafting leaders
            of tomorrow.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 relative group overflow-hidden rounded-3xl border border-gray-150 shadow-md flex flex-col justify-end p-8 min-h-[380px] text-left">
            ...
            <div className="relative z-20 space-y-3.5">
              ...
              <p className="text-xs text-gray-200 leading-relaxed font-sans">
                Experience tree-lined avenues, a high-tech central library, research cells, recreation hubs, and advanced
                mechanical/computing setups designed for complete focus.
              </p>
            </div>
          </div>
