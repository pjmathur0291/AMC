...
export const CAREER_PATHS: CareerPath[] = [
  // B.Tech Paths
  {
    title: 'Software Development & Full Stack Engineer',
...
export const TOP_RECRUITERS = ['Infosys', 'Unisys', 'Flipkart', 'Indiabulls', 'iGate'];
...
// BTech Career Paths
export const BTECH_CAREER_PATHS = ['Software Engineer', 'Data Analyst', 'Core Engineer'];
