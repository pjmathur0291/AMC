...
import { scrollToLeadForm, scrollToProgramsOffered } from './scrollToLeadForm';
...
export default function App() {
  ...
  return (
    <div className="bca-mca-landing font-sans min-h-screen flex flex-col items-stretch overflow-x-hidden antialiased text-slate-900 selection:bg-[#FFD500] selection:text-[#1a1b3a]">
        ...
        <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-3 lg:py-4 flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
          ...
          <div className="flex items-center gap-3 md:gap-5 flex-wrap justify-center">
            ...
            <button
              ...
              className="bg-[#181241] hover:bg-[#201859] text-white font-extrabold px-6 lg:px-8 py-2.5 rounded text-[13px] shadow transition-colors uppercase tracking-widest"
            >
              Apply Now
            </button>
          </div>
      ...
      <main className="flex-grow w-full min-h-[calc(100vh-100px)] lg:min-h-[700px] relative flex items-center py-12 lg:py-16 xl:py-20">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 grid lg:grid-cols-12 gap-12 xl:gap-20 items-stretch">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col justify-center items-start text-left text-white py-8 lg:py-16">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <button
                type="button"
                onClick={scrollToLeadForm}
                className="bg-white hover:bg-slate-50 text-[#1e2444] font-bold text-base px-8 py-3.5 flex items-center justify-center gap-2 w-full sm:w-auto transition-colors rounded"
              >
                Apply Now <ChevronRight size={18} />
              </button>
              <button
                type="button"
                onClick={scrollToProgramsOffered}
                className="bg-transparent hover:bg-white/10 text-white border border-white font-bold text-base px-8 py-3.5 flex items-center justify-center w-full sm:w-auto transition-colors rounded"
              >
                Explore Programs
              </button>
            </div>
          ...
          {/* Right Form Column */}
          <div className="lg:col-span-5 xl:col-span-4 flex items-center justify-center lg:justify-end w-full max-sm:w-[calc(100%+2rem)] max-sm:-mx-4">
            <div
              id="apply-lead-form"
              className="bg-white rounded-xl max-sm:rounded-none shadow-2xl overflow-hidden border border-slate-700/50 w-full max-w-2xl scroll-mt-28"
            >
              ...
              <div className="pb-4 lg:pb-5">
                {/* Callout Box */}
                <div className="mx-4 lg:mx-5 mt-4 lg:mt-5 bg-[#fffdf2] border border-[#fde047] rounded-lg p-2.5 lg:p-3 flex gap-2.5 mb-4 shadow-sm">
                ...
                <div className="flex items-center justify-center gap-1.5 px-4 pt-3 text-[10px] text-slate-400">
      ...
      <section id="programs-offered" className="w-full bg-[#1a1b3a] py-12 lg:py-16 relative z-20 scroll-mt-28">
        <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
                ...
                <div className="flex-1 p-6 lg:p-8 flex flex-col justify-center relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-auto w-full pt-1">
                    <button
                      type="button"
                      onClick={scrollToLeadForm}
                      className="bg-white hover:bg-slate-100 text-[#1a1b3a] font-bold px-8 py-3.5 rounded-lg text-sm transition-colors shadow-sm w-full sm:w-auto uppercase tracking-wide"
                    >
                      Enquire Now
                    </button>
                ...
                <div className="flex-1 p-6 lg:p-8 flex flex-col justify-center relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-auto w-full pt-1">
                    <button
                      type="button"
                      onClick={scrollToLeadForm}
                      className="bg-[#1a1b3a] hover:bg-[#2a2c5a] text-white font-bold px-8 py-3.5 rounded-lg text-sm transition-colors shadow-sm w-full sm:w-auto uppercase tracking-wide"
                    >
                      Enquire Now
                    </button>
