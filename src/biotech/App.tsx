...
export default function App() {
  ...
  return (
    <div className="biotech-landing font-sans min-h-screen flex flex-col items-stretch overflow-x-hidden antialiased bg-[#14172a] text-slate-100 selection:bg-[#FFD500] selection:text-[#1a1b3a]">
      ...
      <main className="flex-grow w-full relative flex items-center min-h-[calc(100vh-76px)] py-12 sm:py-16 lg:py-20 xl:py-24 overflow-hidden border-b border-indigo-900/30">
        ...
        <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 grid lg:grid-cols-12 gap-10 xl:gap-14 items-center">
          ...
          {/* Right Form Column */}
          <div id="apply-form" className="lg:col-span-5 xl:col-span-4 flex items-center justify-center lg:justify-end w-full scroll-mt-24 max-sm:w-[calc(100%+2rem)] max-sm:-mx-4">
            <div className="bg-[#181d33]/92 backdrop-blur-md rounded-2xl max-sm:rounded-none shadow-2xl border border-white/10 w-full max-w-2xl transition-all duration-300 overflow-hidden">
              <div className="p-6 lg:p-7 pb-4 lg:pb-5">
                <h2 className="text-xl lg:text-22px font-extrabold text-white font-sans tracking-tight text-center mb-5">
                  Registration Form
                </h2>

                <div className="bg-[#fffdf2]/10 border border-[#fde047]/30 rounded-lg p-2.5 lg:p-3 flex gap-2.5 mb-4">
                  <div className="bg-[#FFD500] rounded p-1 h-max flex-shrink-0 shadow-sm">
                    <Sparkles size={14} className="text-[#1a1b3a]" />
                  </div>
                  <div>
                    <h4 className="font-extrabold text-white text-[11px] uppercase tracking-wide">Free Biotech Career Counseling</h4>
                    <p className="text-[10px] text-slate-300 mt-0.5 leading-relaxed">
                      Included with every application. Plan your future in research, pharma, or life sciences.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-6 lg:px-7 pb-6 lg:pb-7 pt-3 text-center text-[10px] text-slate-400">
